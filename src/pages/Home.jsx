...
import heroimg from "../assets/images/back1.png";
...
const Home = () => {
  ...
  const [bestSaleProducts, setBestSalesProducts] = useState([]);
          ...
          <Row>
            <Col lg="6" md="6">
              <div className="hero__content">
                ...
                <p>Bye Your Products With Resonable price and fast Delivary.</p>
